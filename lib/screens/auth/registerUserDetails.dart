...
// Widget mySizedBox()
  Widget NextButton(user) => ButtonWidget(
      //  0xFF5DCAD1
      text: 'Next',
      onClicked: () {
  ...
  Widget schoolTextBox() => Container(
      color: Colors.white,
      child: Form(
          child: SizedBox(
              width: 380,
  ...
  Widget graduatingYearTextBox() => Container(
