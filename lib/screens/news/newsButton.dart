...
Widget title() => Container(
    ...
    child: const Text(
      "L’Oreal Brandstorm 2022: Registeration deadline extended",
      style: TextStyle(
          fontSize: 25,
...
Widget date() => Container(
    ...
    child: const Text(
      "7/03/2022",
      style: TextStyle(
          fontSize: 14, color: Color(0xffA19F9F), fontFamily: 'Poppins'),
    ));
...
Widget text() => Container(
    ...
    child: const Text(
      "Good news Brandstormers – you now have three more days to register yourselves on the  Brandstorm 2022 portal AND submit your idea in the form of 3 slides.  For any questions, help or feedback please reach out to the Brandstorm Manager -  Zoha Arif at zoha.arif@loreal.com",
      style: TextStyle(
          fontSize: 12,
...
Widget authorName() => Container(
    ...
    child: const Text(
      ...
      style: TextStyle(
          fontSize: 14, color: Color(0xFF000000), fontFamily: 'Poppins'),
    ));
